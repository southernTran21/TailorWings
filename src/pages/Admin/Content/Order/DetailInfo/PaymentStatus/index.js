        ...
        <div className="admin-order-detail__payment-status">
            <div className="admin-order-detail__payment-status__top d-flex justify-content-between align-items-center">
                <div className="d-flex align-items-center">
                    ...
                    <span className="admin-order-detail__payment-status__top--text font-weight-bold">
                        Unpaid
                    </span>
                </div>
                <div className="admin-order-detail__payment-status__top__button-mark-as-paid d-flex justify-content-center align-items-center">
                    MARK AS PAID
                </div>
            </div>
            <div className="admin-order-detail__payment-status__bot">
                ...
                <div className='d-flex justify-content-between'>
                    ...
                    <span className='font-weight-bold'>2.267.000đ</span>
                </div>
            </div>
        </div>
    );
