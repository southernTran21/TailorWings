                ...
                >
                    ...
                    <Panel header="3. Hướng dẫn thanh toán" key="3">
                        <span>
                            ...
                            thanh toán: <span className="font-weight-bold font-italic">Thanh toán khi nhận hàng</span> và
                            <span className="font-weight-bold font-italic"> Thanh toán chuyển khoản.</span>
                        </span>
                        <br></br>
                        <br></br>
                        <span className="font-weight-bold">Thông tin chuyển khoản</span>
                        <br></br>
                        <br></br>
