...
function StrikingProducts() {
    ...
    /*********************************
     *  Description: handle sliding of carousel
     *
     *
     *  Call by:
     */
    ...
    function bestSellerContent() {
        return bestSellers.map((product, index) => {
            ...
            let totalSupportedFabric = currentDesign
                ? currentDesign.hasOwnProperty("fabricList")
                    ? currentDesign.fabricList.length()
                    : 0
                : 0;
    ...
    if (!bestSellers) return <Fragment></Fragment>;
    return (
        <div className="strikingProducts d-flex flex-column align-items-center fontMontserrat">
            ...
            <div className="carousel-wraper d-flex align-items-center">
                <div className="iconLeft" onClick={() => onSlide("prev")}>
                    <svg
                        width="14"
                        height="22"
                        viewBox="0 0 14 22"
                ...
                <div className="iconRight" onClick={() => onSlide("next")}>
                    <svg
                        width="14"
                        height="22"
                        viewBox="0 0 14 22"
...
export default StrikingProducts;
...
//     bestSellerContent = () => {
//         let { bestSellers, designs } = this.props;
//         return bestSellers.map((product, index) => {
//             let currentDesignID = product.designID;
//             let totalSupportedFabric = 0;
