        ...
        <div className="c-footer">
            <section className="c-footer__section1">
                ...
                <div className="c-footer__social-icon">
                    <img src={IconFaceBook} alt="" className="c-footer__fb" />
                    <img src={IconInstagram} alt="" className="c-footer__ig" />
                    <img src={IconYoutube} alt="" className="c-footer__yt" />
                </div>
            </section>
            <section className="c-footer__section2">
                <div className="c-footer__info">
                    <span className="c-footer__text">HOTLINE 0902 541 398</span>
